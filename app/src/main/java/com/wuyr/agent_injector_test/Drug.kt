package com.wuyr.agent_injector_test
...
import com.wuyr.agent_injector_test.log.logI
...
object Drug {
            ...
            if (activities.isEmpty()) {
                ...
                activities.forEach {
                    ...
                    if (it.isDestroyed) {
                        ...
                        AlertDialog.Builder(it).setMessage("Hello Agent from $application").setPositiveButton("close", null).show()
                    }
                }
    ...
    fun showToast() {
        ...
        runCatching {
            ...
            Toast.makeText(application, "Hello Agent from $application", Toast.LENGTH_LONG).show()
        }.onFailure {
            it.stackTraceToString().logE()
        }
    }
